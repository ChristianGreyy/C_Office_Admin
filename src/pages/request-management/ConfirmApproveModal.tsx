...
interface IConfirmApproveModalProps {
  open: boolean
  isLoading: boolean
  title: string
  content: string
...
const ConfirmApproveModal = (props: IConfirmApproveModalProps) => {
  const { open, isLoading, title, content, onClose, onApprove } = props
