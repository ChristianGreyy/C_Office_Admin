...
import { TUpdateLevelData } from 'src/interfaces'
...
type Props = {
  ...
  isLoading?: boolean
  onClose: () => void
  onSave: (data: TUpdateLevelData) => Promise<void>
}
...
const AddLevelModal = ({ open, onClose, onSave, isLoading }: Props) => {
  const {
    control,
    handleSubmit,
    setValue,
  ...
  return (
    <AppModal open={open} onClose={onClose}>
      <div className="flex items-center justify-between ">
        <div>
          <h1 className="m-0 text-[20px]">Add new level</h1>
        </div>
