...
import { TUpdatePositionData } from 'src/interfaces'
...
type Props = {
  ...
  isLoading?: boolean
  onClose: () => void
  onSave: (data: TUpdatePositionData) => Promise<void>
}
...
const AddPositionModal = ({ open, onClose, onSave, isLoading }: Props) => {
  const {
    control,
    handleSubmit,
    setValue,
  ...
  return (
    <AppModal open={open} onClose={onClose}>
      <div className="flex items-center justify-between ">
        <div>
          <h1 className="m-0 text-[20px]">Add new position</h1>
        </div>
            ...
            <Controller
              ...
              render={({
                ...
                return (
                  <Input
                    alignment="col"
                    label={t('position:name') as string}
                    name="name"
                    className="input "
                    value={value}
                    type="text"
            ...
            <Controller
              ...
              render={({
                ...
                return (
                  <Input
                    alignment="col"
                    label={t('position:color') as string}
                    name="color"
